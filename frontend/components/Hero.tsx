    ...
    return <div>
        ...
        <div className="flex justify-center pt-2">
            <div className="text-xl font-bold font-normal text-center pt-8 max-w-2xl">
                AI gives you automation superpowers, and ZapDash puts them to work. Pairing AI and ZapDash helps you turn ideas into workflows and bots that work for you.
            </div>
        </div>
